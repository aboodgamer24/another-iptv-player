...
import 'package:c4tv_player/database/drift_flutter.dart';
...
import 'package:c4tv_player/models/server_info.dart';
import 'package:c4tv_player/models/user_info.dart';
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<List<VodStream>> getRandomVodStreams(
    String playlistId,
    int count,
  ) async {
    final query = select(vodStreams)
  ...
  Future<List<SeriesStream>> getRandomSeriesStreams(
    String playlistId,
    int count,
  ) async {
    final query = select(seriesStreams)
