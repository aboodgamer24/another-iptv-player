...
class _C4LiveGridScreenState extends State<C4LiveGridScreen> {
  ...
  @override
  void dispose() {
    _exitFullscreen(); // Ensure system UI is restored
  ...
  Widget build(BuildContext context) {
    ...
    // Build the PlayerWidget once so it can be moved between states
    final playerContent = _selectedChannel == null
                        ...
                        return _CategoryTile(
                          ...
                          onTap: () {
                            setState(() {
                              ...
                              _selectedChannel =
                                  null; // Reset selection on category change
                            });
                          },
                        );
                      },
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          _playerKey =
                                              UniqueKey(); // forces rebuild & new stream
                                        });
                                      },
                                      child: Padding(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: () => navigateByContentType(
                                  context, _selectedChannel!),
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              onPressed: () => favoritesController
                                  .toggleFavorite(_selectedChannel!),
                              icon: Icon(
                                favoritesController.favorites.any((f) =>
                                        f.streamId == _selectedChannel!.id)
                                    ? Icons.favorite_rounded
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                side: BorderSide(
                                  color: favoritesController.favorites.any((f) =>
                                          f.streamId == _selectedChannel!.id)
