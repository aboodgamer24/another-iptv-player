...
class _TvLiveTvScreenState extends State<TvLiveTvScreen> {
  ...
  Widget build(BuildContext context) {
            ...
            Focus(
              ...
              child: Builder(builder: (ctx) {
                ...
                return GestureDetector(
                  onTap: () => ctrl.refreshAllData(context),
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                    decoration: BoxDecoration(
                      color: f ? Colors.white12 : Colors.white10,
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(color: f ? primary : Colors.transparent, width: 2),
                    ),
    ...
    final channels = ctrl.getLiveChannelsByCategory(categories[safecat].category.categoryId);
        ...
        children: [
                          ...
                          child: Builder(builder: (ctx) {
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                                  color: hasFocus ? primary : (isSelected ? Colors.transparent : Colors.transparent),
                                  width: 2,
                                ),
                              ),
                              child: Stack(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      categories.isNotEmpty ? categories[safecat].category.categoryName.toUpperCase() : '',
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: hasFocus
                                      ...
                                      : (isSelected ? primary.withValues(alpha: 0.15) : Colors.transparent),
                                  borderRadius: BorderRadius.circular(8),
                                  border: Border.all(color: hasFocus ? primary : Colors.transparent, width: 2),
                                ),
                                child: Row(
                                  children: [
                                    Container(
          ...
          Expanded(
            child: _TvLivePreviewPanel(
              ...
              onWatch: previewItem == null ? null : () => _openChannel(previewItem, channels, safechan),
              onFavorite: previewItem == null
                  ? null
                  : () async {
    ...
    if (item == null) {
      return const Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.live_tv, size: 64, color: Colors.white10),
            SizedBox(height: 16),
            Text('Select a channel', style: TextStyle(color: Colors.white24, fontSize: 16)),
          ],
        ),
      );
    }
        ...
        children: [
          ...
          Container(
            ...
            child: item!.imagePath.isNotEmpty
                ? Image.network(item!.imagePath,
                    fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => const Icon(Icons.live_tv, size: 48, color: Colors.white24))
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                SizedBox(width: 8),
                Text('Press OK to Watch', style: TextStyle(color: Colors.white, fontSize: 16)),
              ],
            ),
          ),
          const SizedBox(height: 16),
          ...
          if (onFavorite != null)
            TextButton.icon(
              ...
              icon: const Icon(Icons.favorite_border, color: Colors.white38, size: 18),
              label: const Text('Add to Favorites', style: TextStyle(color: Colors.white38, fontSize: 13)),
            ),
        ],
      ),
    );
